...
export default Navbar;
//we can use grid for to solve my problem to put logo,welcome, till reservations in div1 and cart, cartcount, login signup in div 2 
// to beautify and make this good and gap between them 